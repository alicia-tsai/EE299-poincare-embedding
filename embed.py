...
from model import PoincareDistance, EuclideanDistance, TranseDistance, SNGraphDataset
import train, rsgd
...
def main(opt):
    ...
    model, data, model_name, conf = SNGraphDataset.initialize(distfn, opt, idx, objects)
